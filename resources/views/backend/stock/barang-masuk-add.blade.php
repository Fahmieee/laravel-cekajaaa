...
<div>
    <p> 
        <a title="Return" href="{{url('admin/barang-masuk-stock')}}">
    ...
    <div class="panel panel-default">
        ...
        <form id="formAddSave" class="form-horizontal" method="POST" action="{{url('admin/barang-masuk-stock/add-save')}}">
                ...
                <div class="box-body" id="parent-form-area">      
                    ...
                    <div id="wrapDesc">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" title="No PO" required class="form-control" name="no_po" id="no_po" value="{{ old('no_po') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2">
